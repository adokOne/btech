         ...
         <div id="center_column" class="center_column col-xs-12 col-sm-12">
            ...
            <div class="row">
               <div class="col-xs-12 col-sm-6">
                  <form action="<?php echo url::base()?>users/login" method="post" id="create-account_form" class="box">
               ...
               <div class="col-xs-12 col-sm-6">
                  <form action="<?php echo url::base()?>users/registration" method="post" id="login_form" class="box">
