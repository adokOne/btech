         ...
         <html class="no-js ie9" lang="en">
            ...
            <html lang="en">
               <head>
                  ...
                  <link rel="icon" type="image/vnd.microsoft.icon" href="/prestashop_51239/img/favicon.ico?1410520368" />
                  <link rel="shortcut icon" type="image/x-icon" href="/prestashop_51239/img/favicon.ico?1410520368" />
                  <?php echo css::render();?>
                  ...
                  <script type="text/javascript">
                     ...
                     var ajaxsearch = true;
                     var baseDir = 'http://livedemo00.template-help.com/prestashop_51239/';
                     var baseUri = 'http://livedemo00.template-help.com/prestashop_51239/index.php';
                     ...
                     var id_lang = 1;
                     var img_dir = 'http://livedemo00.template-help.com/prestashop_51239/themes/theme1038/img/';
                     ...
                     var mywishlist_url = 'http://livedemo00.template-help.com/prestashop_51239/index.php?fc=module&module=blockwishlist&controller=mywishlist&id_lang=1';
                     ...
                     var roundMode = 2;
                     var search_url = 'http://livedemo00.template-help.com/prestashop_51239/index.php?controller=search';
                              ...
                              <div class="container">
                                 <div class="row">
                                    <nav>
                                       ...
                                       <div class="header_user_info">
                                          <a  href="<?php echo url::base()?>login" title="<?php echo $lang["login"]?>"><?php echo $lang["login"]?></a>
                                       </div>
                                 ...
                                 <div class="row">
                                    <div id="header_logo">
                                       <a href="/" title="T-shirts">
                                        <img class="logo img-responsive" src="/img/front/logo.png" alt="<?php Kohana::config("core.site_name")?>" width="226" height="44"/>
                                       </a>
                                    </div>
                                    <!-- MODULE Block cart -->
                                    <div class="">
                                             ...
                                             <div class="block_content">
                                                ...
                                                <div class="cart_block_list">
                                                   ...
                                                   <p class="cart-buttons">
                                                      <a id="button_order_cart" class="btn btn-default btn-sm icon-right" href="http://livedemo00.template-help.com/prestashop_51239/index.php?controller=order-opc" title="Check out" rel="nofollow">
                                                      <span>
                                                      Check out
                                                      </span>
                                                      </a>
                                       ...
                                       <div class="clearfix">
                                          ...
                                          <div class="layer_cart_cart col-xs-12 col-md-6">
                                             ...
                                             <div class="button-container"> 
                                                ...
                                                <a class="btn btn-default btn-md icon-right" href="http://livedemo00.template-help.com/prestashop_51239/index.php?controller=order-opc" title="Proceed to checkout" rel="nofollow">
                                                <span>
                                                Proceed to checkout
                                                </span>
                                                </a>  
