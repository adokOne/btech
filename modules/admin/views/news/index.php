				...
				<div role="content">
					...
					<div class="widget-body no-padding">
						<table id="datatable_fixed_column" class="table table-striped table-bordered dataTable no-footer" width="100%" role="grid" aria-describedby="datatable_fixed_column_info" style="width: 100%;">
					        ...
					        <thead>
					            <tr role="row">
					            	<th tabindex="0" rowspan="1" colspan="1"><?php echo $admin_lang["news"]["name"]?></th>
					            	<th tabindex="0" rowspan="1" colspan="1"><?php echo $admin_lang["news"]["desc"]?></th>
					            	<th tabindex="0" rowspan="1" colspan="1"><?php echo $admin_lang["news"]["status"]?></th>
					        ...
					        <?php foreach($items as $k=>$item):?>    
						        <tr role="row" class="<?php echo $k%2 > 0 ? "odd" : "even"?>">
						                ...
						                <td>
						                	<a class="btn btn-warning" href="/admin/news/edit/<?php echo $item->id?>"><?php echo $admin_lang["edit"]?></a>
						                	<a class="btn btn-danger" href="/admin/news/delete/<?php echo $item->id?>"><?php echo $admin_lang["delete"]?></a>
						                </td>
						        </tr>
					    	<?php endforeach;?>
					    	</tbody>
