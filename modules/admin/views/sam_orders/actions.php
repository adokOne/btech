	<div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
		<ul id="sparks" class="">
			<li class="sparks-info">
				<a class="btn btn-success" href="/admin/samorders/index">Сбросить фильтр</a>
			</li>
			<li class="sparks-info">
				<a class="btn btn-primary" href="/admin/samorders/new_one">Добавить</a>
			</li>
			<li class="sparks-info">
				<a class="btn btn-warning" href="/admin/samorders/export">Екпорт в Exel</a>
			</li>
			<li class="sparks-info">
