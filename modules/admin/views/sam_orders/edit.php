<div class="jarviswidget jarviswidget-sortable" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget" style="">
				...
				<div role="content">
					...
					<div class="widget-body no-padding">
						...
						<form action="/admin/samorders/update" method="POST" class="smart-form">
												...
												<div class="row">
													<div class="col col-10" style="padding-bottom: 10px;">
														<label class="checkbox">
															<input name="object[ingredient][id][<?php echo $good->id?>]" type="checkbox" name="checkbox" <?php echo array_key_exists($good->id, $object->ingredients()) ? 'checked="checked"' : ""?>>
															<i></i><?php echo $good->name(); ?>
														</label>
													</div>
													<div class="col col-2">
														<label class="select">
															<select name="object[ingredient][count][<?php echo $good->id?>]" class="input-sm">
																<?php for($i=1;$i<7;$i++):?>
																	<option <?php echo array_key_exists($good->id, $object->ingredients()) && $object->ingredients[$good->id] == $i ? 'selected="selected"' : ""?> value="<?php echo $i?>"><?php echo $i?></option>
																<?php endfor;?>
															</select><i></i> 
														</label>
													</div>
