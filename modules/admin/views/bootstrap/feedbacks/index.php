...
<!-- 							<div class="col-xs-9 col-sm-5 col-md-5 col-lg-5">
							...
							<div class="col-xs-3 col-sm-7 col-md-7 col-lg-7 text-right">
								<a class="btn btn-success" href="/admin/feedbacks/new_item">
								...
								<tbody role="alert" aria-live="polite" aria-relevant="all">
									<?php foreach($items as $item):?>
										<tr class="odd">
											...
											<td class=" "><?php echo text::limit_chars($item->text,50,"...")?></td>

											<td class=" sorting_1">
												<a style="float: right;" href="/admin/feedbacks/answer/<?php echo $item->id?>" class="btn btn-primary">
													<i class="fa fa-gear"></i> 
													Відповісти
												</a>
												<a style="float: right;" href="/admin/feedbacks/edit/<?php echo $item->id?>" class="btn btn-primary">
													<i class="fa fa-gear"></i> 
													Редагувати
												</a>

												<a style="float: right;"  href="/admin/feedbacks/delete/<?php echo $item->id?>" class="btn btn-danger">
