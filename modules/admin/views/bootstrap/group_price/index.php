...
<!-- 							<div class="col-xs-9 col-sm-5 col-md-5 col-lg-5">
							...
							<div class="col-xs-3 col-sm-7 col-md-7 col-lg-7 text-right">
								<a class="btn btn-success" href="/admin/prices/new_item">
								...
								<tbody role="alert" aria-live="polite" aria-relevant="all">
									<?php foreach($items as $item):?>
										<tr class="odd">
											...
											<td class=" "><?php echo $item->course->name()?></td>
											<td class=" "><?php echo $item->price_2?></td>
											<td class=" "><?php echo $item->price_4?></td>
											<td class=" "><?php echo $item->price_6?></td>
											<td class=" "><?php echo $item->price_8?></td>
											<td class=" sorting_1">
												<a href="/admin/prices/edit/<?php echo $item->id?>" class="btn btn-primary">
													<i class="fa fa-gear"></i> 
													Редагувати
												</a>
												<a href="/admin/prices/delete/<?php echo $item->id?>" class="btn btn-danger">
