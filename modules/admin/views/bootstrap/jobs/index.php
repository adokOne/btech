...
<!-- 							<div class="col-xs-9 col-sm-5 col-md-5 col-lg-5">
							...
							<div class="col-xs-3 col-sm-7 col-md-7 col-lg-7 text-right">
								<a class="btn btn-success" href="/admin/jobs/new_item">
								...
								<tbody role="alert" aria-live="polite" aria-relevant="all">
									<?php foreach($jobs as $job):?>
										<tr class="odd">
											...
											<td class=" "><?php echo $job->name()?></td>
											<td class=" sorting_1">
												<a href="/admin/jobs/edit/<?php echo $job->id?>" class="btn btn-primary">
													<i class="fa fa-gear"></i> 
													Редагувати
												</a>
												<a href="/admin/jobs/delete/<?php echo $job->id?>" class="btn btn-danger">
